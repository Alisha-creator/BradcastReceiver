package alisha.digipodium.bradcastreceiver;
...
public class FirstFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        receiver = new PowerStausReceiver();
    ...
    class PowerStausReceiver extends BroadcastReceiver{
